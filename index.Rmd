...
# Checking normality
library(ggpubr)
ggqqplot(data_2014$age_adjusted_rate, ylab = "Overdose Rate")
ggqqplot(data_2014$prescription_rate, ylab = "Prescription Rate")
```
...
Prescription rates aren't the only factor contributing to overdose rates throughout the United State. Other factors such as naloxone availiblity, poverty, and access to hospitals could absolutely play a role in contributing to overdose rates in the US. 
